    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Snama.equals("") && Skelas.equals("")){
                    Enama.requestFocus();
                    Toast.makeText(MainCreate.this, "Isi Data Terlebih Dahulu!",
                            Toast.LENGTH_SHORT).show();
                }
                else if (Snama.equals("")){
                    Enama.requestFocus();
                    Toast.makeText(MainCreate.this, "Nama Tidak Boleh Kosong!",
                            Toast.LENGTH_SHORT).show();
                }
                else if (Skelas.equals("")) {
                    Ekelas.requestFocus();
                    Toast.makeText(MainCreate.this, "Kelas Tidak Boleh Kosong!",
                            Toast.LENGTH_SHORT).show();
                }
                else {
                    Enama.setText("");
